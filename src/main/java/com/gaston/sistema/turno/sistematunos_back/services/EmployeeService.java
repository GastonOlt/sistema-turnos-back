...
public interface EmployeeService {
    EmployeeDTO createEmployee(EmployeeRequestDTO request, Long ownerId, org.springframework.web.multipart.MultipartFile file);
    EmployeeDTO editEmployee(EmployeeRequestDTO request, org.springframework.web.multipart.MultipartFile file, Long employeeId, Long ownerId);
